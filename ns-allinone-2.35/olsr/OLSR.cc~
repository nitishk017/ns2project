	...
	if (argc == 2) {
		...
		// Prints routing table
			...
			if (logtarget_ != NULL) {
				...
				printf("[print_rtable] CURRENT_TIME : %f Node_ID : %d Routing Table\n",CURRENT_TIME,OLSR::node_id(ra_addr()));
				logtarget_->pt_->dump();
		...
		// Prints link set
			...
			if (logtarget_ != NULL) {
				...
				printf("[print_linkset] CURRENT_TIME:%f Node_ID: %d Link Set\n",CURRENT_TIME,OLSR::node_id(ra_addr()));
			}
			else {
		...
		// Prints neighbor set
			...
			if (logtarget_ != NULL) {
				sprintf(logtarget_->pt_->buffer(), "P %f _%d_ Neighbor Set",
					CURRENT_TIME,
					OLSR::node_id(ra_addr()));
					printf("[print_nbset]CURRENT_TIME: %f Node_ID: %d Neighbor Set\n",CURRENT_TIME,OLSR::node_id(ra_addr()));
				logtarget_->pt_->dump();
		...
		// Prints 2-hop neighbor set
			...
			if (logtarget_ != NULL) {
				...
				printf("[print_nb2hopset]CURRENT_TIME: %f Node_ID :%d Neighbor2hop Set\n",CURRENT_TIME,OLSR::node_id(ra_addr()));
			}
			else {
		...
		// Prints MPR set
			...
			if (logtarget_ != NULL) {
				sprintf(logtarget_->pt_->buffer(), "P %f _%d_ MPR Set",
					CURRENT_TIME,
					OLSR::node_id(ra_addr()));
				printf("[print_mprset] CURRENT_TIME: %f Node_ID: %d MPR Set\n",CURRENT_TIME,OLSR::node_id(ra_addr()));
				logtarget_->pt_->dump();
		...
		// Prints MPR selector set
			...
			if (logtarget_ != NULL) {
				...
				printf("[print_mprselset] CURRENT_TIME:%f Node_ID:%d MPR Selector Set\n",CURRENT_TIME,OLSR::node_id(ra_addr()));
			}
			else {
		...
		// Prints topology set
			...
			if (logtarget_ != NULL) {
				...
				printf("[print_topologyset] CURRENT_TIME:%f Node_ID:%d  Topology Set\n",CURRENT_TIME,OLSR::node_id(ra_addr()));
			}
			else {
