...
\"\n\
checkout_executable TCLSH \"/home/kpit/Sprint3/ns-allinone-2.35/bin/tclsh8.5\" tclsh \"\\\n\
When configured, ns found the right version of tclsh in\\\n\
/home/kpit/Sprint3/ns-allinone-2.35/bin/tclsh8.5\n\
but it doesn't seem to be there anymore, so\\\n\
...
\n\
\n\
set kmanetonly [string first \"KMANET\" [$agent info class]] \n\
if {$aodvonly != -1 } {\n\
$agent if-queue [$self set ifq_(0)]   ;# ifq between LL and MAC\n\
}\n\
\n\
...
KMANET  # routing protocol for ad-hoc networks\n\
...
\n\
Agent/KMANET set sport_   0\n\
Agent/KMANET set dport_   0\n\
\n\
\n\
...
KMANET {\n\
set ragent [$self create-kmanet-agent $node]\n\
}\n\
MDART {\n\
...
\n\
Simulator instproc create-kmanet-agent { node } {\n\
set ragent [new Agent/KMANET [$node node-addr]]\n\
$self at 0.0 \"$ragent start\"\n\
$node set ragent_ $ragent\n\
return $ragent\n\
}\n\
